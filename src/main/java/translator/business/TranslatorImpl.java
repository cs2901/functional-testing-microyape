...
public class TranslatorImpl{
    ...
    private void createURLS(String initLang, String targetLang, String word) {
        try{
            url = new URL(
    ...
    private String parseResponse(String response){
        ...
        try {
            parsedResponse = new JSONArray(response);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        for (int i=0; i<2; ++i) {
            try {
                parsedResponse = (JSONArray) parsedResponse.get(0);
            } catch (JSONException e) {
                e.printStackTrace();
            }
        }
    ...
    public String translate(String initLang, String targetLang, String word){
        createURLS(initLang, targetLang, word);
